...
public class BIP38 {
    ...
    public BIP38(final BitcoinEnv bitcoinEnv) {
     ...
     */
    @SneakyThrows
    public String generateEncryptedKey(String passphrase) {
     ...
     */
    public GeneratedKey encryptedKeyFromIntermediate(byte[] intermediate) throws GeneralSecurityException {

...
@Slf4j
@Component
public class MaticRawVerifier implements Verifier<MaticRawVerifiable> {


    public static final String MESSAGE_PREFIX = "\u0019Ethereum Signed Message:\n";

    @Override
    public boolean isValidSignature(MaticRawVerifiable verifiable) {
        try {
    ...
    private boolean verifyMessage(MaticRawVerifiable verifiable) {

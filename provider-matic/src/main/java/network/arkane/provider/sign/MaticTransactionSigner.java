...
@Component
public class MaticTransactionSigner implements Signer<MaticTransactionSignable, MaticSecretKey> {
    private static final String DEFAULT_DATA = "0x";

    @Override
    public Signature createSignature(final MaticTransactionSignable signable,
                                     final MaticSecretKey key) {
    ...
    private org.web3j.crypto.RawTransaction constructTransaction(final MaticTransactionSignable signTransactionRequest) {

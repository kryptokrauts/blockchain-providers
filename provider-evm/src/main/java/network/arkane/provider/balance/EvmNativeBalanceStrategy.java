...
@Slf4j
public abstract class EvmNativeBalanceStrategy implements EvmBalanceStrategy {

    private EvmWeb3jGateway web3JGateway;
    private final TokenDiscoveryService tokenDiscoveryService;

    public EvmNativeBalanceStrategy(final EvmWeb3jGateway web3JGateway,
    ...
    public List<TokenBalance> getTokenBalances(final String walletAddress,
        ...
        final List<TokenInfo> tokenInfoList = tokenAddresses.stream()

...
public class PrecisionUtil {
    ...
    public static double toDecimal(final BigInteger rawValue, final int precision) {
        return new BigDecimal(rawValue).divide(BigDecimal.TEN.pow(precision), precision, RoundingMode.HALF_DOWN).doubleValue();
    }

    public static BigInteger toRaw(final BigDecimal decimalValue, final int precision) {

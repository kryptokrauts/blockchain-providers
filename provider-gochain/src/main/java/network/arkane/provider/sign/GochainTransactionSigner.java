...
@Component
public class GochainTransactionSigner implements Signer<GochainTransactionSignable, GochainSecretKey> {
    private static final String DEFAULT_DATA = "0x";

    @Override
    public Signature createSignature(final GochainTransactionSignable signable, final GochainSecretKey key) {
    ...
    private org.web3j.crypto.RawTransaction constructTransaction(final GochainTransactionSignable signTransactionRequest) {

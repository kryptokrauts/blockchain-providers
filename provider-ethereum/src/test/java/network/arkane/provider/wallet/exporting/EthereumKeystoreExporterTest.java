...
class EthereumKeystoreExporterTest {
    ...
    @Test
    void exports() {
        final String export = ethereumKeystoreExporter.export(EthereumKeyExportRequest.builder()
                                                                                      .password("test")
                                                                                      .secretKey(EthereumSecretKey.builder().keyPair(ECKeyPair.create(BigInteger.ZERO)).build())
                                                                                      .build());
    ...
    void exportButException() {
        ...
        assertThatThrownBy(() -> ethereumKeystoreExporter.export(EthereumKeyExportRequest.builder()
                                                                                         .password("test")
                                                                                         .secretKey(EthereumSecretKey.builder()
                                                                                                                     .keyPair(null)
                                                                                                                     .build())

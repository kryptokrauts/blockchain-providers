...
class SoChainClientTest {
    ...
    @Test
    void getBalance() {
        SoChainResult<BalanceResult> balance = client.getBalance(USER_AGENT, "BTCTEST", "mwN1cqMbvLacFY6PuKR9whUp1cCktg9DNt");
    ...
    void getUnspentTransactions() {
        SoChainResult<Transactions> result = client.getUnspentTransactions(USER_AGENT, "BTCTEST", "mwN1cqMbvLacFY6PuKR9whUp1cCktg9DNt");
    ...
    void getSpentTransactions() {
        SoChainResult<Transactions> result = client.getSpentTransactions(USER_AGENT, "BTCTEST", "mwN1cqMbvLacFY6PuKR9whUp1cCktg9DNt");
    ...
    void getReceivedTransactions() {
        SoChainResult<Transactions> result = client.getReceivedTransactions(USER_AGENT, "BTCTEST", "mwN1cqMbvLacFY6PuKR9whUp1cCktg9DNt");
    ...
    void send() {
        ...
        SoChainResult<SendSignedTransactionResult> result = client.sendSignedTransaction(USER_AGENT, "BTCTEST", request);
